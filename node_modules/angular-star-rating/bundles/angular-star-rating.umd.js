(function (global, factory) {
	...
	typeof define === 'function' && define.amd ? define('angular-star-rating', ['@angular/core','@angular/common','exports', '@angular/core', '@angular/forms', '@angular/common'], factory) :
	(factory(global.ng.core,global.ng.common,(global['angular-star-rating'] = {}),global.ng.core,global.ng.forms,global.ng.common));
...
StarRatingModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function StarRatingModule_Factory(t) { return new (t || StarRatingModule)(); }, imports: [[common.CommonModule]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(StarRatingModule, { declarations: [StarRatingComponent, StarRatingControlComponent], imports: [ɵngcc1.CommonModule], exports: [StarRatingComponent, StarRatingControlComponent] }); })();
