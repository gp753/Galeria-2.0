(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('ng2-file-upload', ['@angular/core','@angular/common','exports', '@angular/core', '@angular/common'], factory) :
    (global = global || self, factory(global.ng.core,global.ng.common,global['ng2-file-upload'] = {}, global.ng.core, global.ng.common));
...
FileUploadModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function FileUploadModule_Factory(t) { return new (t || FileUploadModule)(); }, imports: [[common.CommonModule]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(FileUploadModule, { declarations: [FileDropDirective, FileSelectDirective], imports: [ɵngcc1.CommonModule], exports: [FileDropDirective, FileSelectDirective] }); })();
